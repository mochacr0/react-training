        ...
        <>
            <footer className="mx-4 my-6 rounded-lg bg-white p-4 shadow dark:bg-gray-800 md:flex md:items-center md:justify-between md:p-6 xl:p-8">
                <ul className="mb-6 flex flex-wrap items-center space-y-1 md:mb-0">
                    ...
                    <li>
                        <Link to="#" className="text-sm font-normal text-gray-500 hover:underline dark:text-gray-400">
                            Contact
                        </Link>
                    </li>
                </ul>
            ...
            <p className="my-10 text-center text-sm text-gray-500">
                © 2019-2024{" "}
                <Link to="https://flowbite.com/" className="hover:underline" target="_blank">
                    Flowbite.com
                </Link>
                . All rights reserved.
            </p>
